...
?>
<section class="utbildningsomraden p-4 clearfix">
    <h2 class="section_title text-center p-4"><?php echo $utbildningsomraden; ?></h2>
        <div class="container">
            <div class="row">
                <?php
                    ...
                    while (have_rows('amne_names')): the_row();
                        ...
                        <div class="amne-entry col-lg-4 col-md-4 col-sm-6 col-xs-12 p-2">
                            ...
                            <div class="text-white hovereffect">
                                ...
                                <div class="overlay">
                                    <h2 class="text-white"><?php echo $amne_title; ?></h2>
                ...
                <div class="amne-entry col-lg-4 col-md-4 col-sm-6 col-xs-12 p-2">
                    ...
                    <div class="text-white hovereffect">
                        <img src="/wp-content/uploads/2016/02/AH-Örebro-Artikelkort.jpg" class="img-responsive"
                             alt="<?php echo $amne_title; ?>">
                        <div class="overlay">
                            <h2 class="text-white">Alla utbildningar</h2>
            ...
            <p class="orter_text text-center m-4 p-4"><?php echo $orter_text; ?></p>
        </div>
